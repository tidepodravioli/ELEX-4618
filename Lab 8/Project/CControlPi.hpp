...
#define COUNT_DIGITAL_OUT_PINS 4
#define COUNT_ANALOG_PINS 2
#define COUNT_SERVO_PINS 1

static const int DIGITAL_IN_PINS[] = {CH_SWITCH_S1, CH_SWITCH_S2};
static const int DIGITAL_OUT_PINS[] = {CH_RGBLED_RED_PIN, CH_RGBLED_GRN_PIN, CH_RGBLED_BLU_PIN, CH_PWM_MOTOR};
